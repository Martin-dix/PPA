...
async function generatePDFReport() {
  if (!state.txMarker || !state.rxMarker) {
    alert('Place Tx/Rx and run Analyse Path first.');
    return;
  }
  ...
  try {
    ...
    // Footer
    pdf.setFontSize(10);
    pdf.text('Generated by RF Path Analyser • Open-Meteo DEM • FSPL + Knife-edge + Fresnel', pw / 2, pdf.internal.pageSize.getHeight() - 10, { align: 'center' });
